...
private const val PORTAL_KEY = "portal POH"
const val LUNAR_ISLE_HOUSE_PORTAL = "Lunar isle $PORTAL_KEY"
const val KOUREND_HOUSE_PORTAL = "Kourend $PORTAL_KEY"
...
enum class HousePortal(override val destination: Tile) : HouseTeleport {
    ...
    companion object {
        fun forName(portalName: String): HousePortal? {
            return if (!portalName.contains(PORTAL_KEY)) null
