...
enum class BankType {
    BOOTH, BUFFALO, CHEST, NPC, DEPOSIT_BOX
}
...
enum class BankLocation(
    ...
    AUBERVALE_NORTH_NORTH(Tile(1416, 3355, 0), BankType.BOOTH),
    AUBERVALE_NORTH_EAST(Tile(1418, 3353, 0), BankType.BOOTH),
    AUBERVALE_NORTH_SOUTH(Tile(1416, 3351, 0), BankType.BOOTH),
    AUBERVALE_NORTH_WEST(Tile(1414, 3353, 0), BankType.BOOTH),
    AUBERVALE_SOUTH(Tile(1387, 3311, 0), BankType.BUFFALO),
