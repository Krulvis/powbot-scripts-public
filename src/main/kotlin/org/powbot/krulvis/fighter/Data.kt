...
enum class Superior(val protectPrayer: Prayer.Effect = Prayer.Effect.PROTECT_FROM_MELEE) {
	...
	INFERNAL_PYRELORD,
	MONSTROUS_BASILISK,
	MALEVOLENT_MAGE(Prayer.Effect.PROTECT_FROM_MAGIC),
	...
	MUTATED_TORTOISE,
	CAVE_ABOMINATION,
	ABHORRENT_SPECTRE(Prayer.Effect.PROTECT_FROM_MAGIC),
	REPUGNANT_SPECTRE(Prayer.Effect.PROTECT_FROM_MAGIC),
	BASILISK_SENTINEL,
	SHADOW_WYRM,
	CHOKE_DEVIL,
	KING_KURASK,
	...
	NIGHT_BEAST,
	NUCLEAR_SMOKE_DEVIL(Prayer.Effect.PROTECT_FROM_MISSILES),
	COLOSSAL_HYDRA(Prayer.Effect.PROTECT_FROM_MAGIC),
	;
